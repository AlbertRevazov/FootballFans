            ...
            {data.data?.map((stand: Standings) =>
              stand.table.map((row) => (
                <TableRow key={row.position}>
                  ...
                  <TableCell sx={styles.darkTableCell}>{row.draw}</TableCell>
                  <TableCell sx={styles.darkTableCell}>{row.lost}</TableCell>
                  <TableCell sx={styles.darkTableCell}>
                    {row.goalsFor}
                  </TableCell>
                  <TableCell sx={styles.darkTableCell}>
                  ...
                  <TableCell sx={styles.darkTableCell}>{row.points}</TableCell>
                </TableRow>
              ))
            )}
          </TableBody>
